...
namespace Proto
{
	...
	public partial class S1 : IProtoStruct 
	{
		public int V;
		...
		public void Marshal(OutputStream stream)
		{  
			stream.WriteInt32(1, V ); 
		}

		public int GetSize()
		{
			int size = 0;  
			size += OutputStream.SizeInt32(1, V); 
			return size;
		}
	...
	public partial class S2 : IProtoStruct 
	{
		public int V;
		public string S;
		...
		public int GetSize()
		{
			int size = 0;  
			size += OutputStream.SizeInt32(1, V);  
			size += OutputStream.SizeString(2, S); 
			return size;
		}
